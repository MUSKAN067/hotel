...
<div class="banner-top">
			<div class="social-bnr-agileits">
				<ul class="social-icons3">
								...
								<li><a href="https://instagram.com/" class="fa fa-instagram icon-border instagram"> </a></li>
								<li><a href="https://twitter.com/u/0/" class="fa fa-twiter icon-border twitter"> </a></li> 
							</ul>
			</div>
			<div class="contact-bnr-w3-agile">
				<ul>
					<li><i class="fa fa-envelope" aria-hidden="true"></i><a href="mailto:info@example.com">INFO@HOLIDAYIN.COM</a></li>
		...
		<div class="container">
			<nav class="navbar navbar-default">
				<div class="navbar-header navbar-left">
					...
					<h1><a class="navbar-brand" href="index.php">HOLIDAY <span>IN</span><p class="logo_w3l_agile_caption">Your Dreamy Destination</p></a></h1>
				</div>
							...
							<div class="container">
								...
								<h4>HOLIDAY IN</h4>
									<h3>Stay with friends & families</h3>
										<p>Come , enjoy & make memories with us</p>
									<div class="agileits_w3layouts_more menu__item">
				<a href="#" class="menu__link" data-toggle="modal" data-target="#myModal">Learn More</a>
			</div>
								</div>	
							...
							<!-- Modal content-->
								<div class="modal-content">
									<div class="modal-header">
										...
										<h4>HOLIDAY  <span>IN</span></h4>
										<img src="images/1.jpg" alt=" " class="img-responsive">
										<h5>We OFFER what you LOVE</h5>
				...
				<ul class="cbp-ig-grid">
					<li>
						<div class="w3_grid_effect">
							...
							<span class="cbp-ig-category">HOLIDAY IN</span>
						</div>
					</li>
					<li>
						<div class="w3_grid_effect">
 	...
 	<div class="about-wthree" id="about">
		  <div class="container">
				   <div class="ab-w3l-spa">
                            <h3 class="title-w3-agileits title-black-wthree">About Our HOLIDAY IN</h3> 
...
<section class="contact-w3ls" id="contact">
	<div class="container">
		...
		<div class="col-lg-6 col-md-6 col-sm-6 contact-w3-agile1" data-aos="flip-right">
			...
			<p class="contact-agile1"><strong>Email :</strong> <a href="mailto:name@example.com">INFO@HOLIDAYIN.COM</a></p>
			<p class="contact-agile1"><strong>Address :</strong> Near Kalyan, Batticaloa, Mumbai</p>
...
<!-- /contact -->
			<div class="copy">
		        <p>© 2020 HOLIDAYIN . All Rights Reserved | Design by <a href="index.php">HOLIDAYIN</a> </p>
		    </div>
<!--/footer -->
<!-- js -->
